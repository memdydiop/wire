...
$classes = Flux::classes()
    ...
    ->add([
        'bg-white',
        '[ui-checkbox[data-checked]_&]:bg-primary',
        'hover:[ui-checkbox[data-checked]_&]:bg-primary',
        'focus:[ui-checkbox[data-checked]_&]:bg-primary',
        '[ui-checkbox[data-indeterminate]_&]:bg-primary',
        'hover:[ui-checkbox[data-indeterminate]_&]:primary',
        'focus:[ui-checkbox[data-indeterminate]_&]:primary',
    ])
    ;
@endphp
