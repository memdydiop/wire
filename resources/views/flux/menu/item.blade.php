...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        'primary' => [
            'text-slate-600 data-active:text-primary data-active:bg-primary/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'secondary' => [
            'text-slate-600 data-active:text-secondary data-active:bg-secondary/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'info' => [
            'text-slate-600 data-active:text-info data-active:bg-info/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'success' => [
            'text-slate-600 data-active:text-success data-active:bg-success/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'warning' => [
            'text-slate-600 data-active:text-warning data-active:bg-warning/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'danger' => [
            'text-slate-600 data-active:text-danger data-active:bg-danger/10',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'default' => [
            'text-slate-600 data-active:bg-zinc-50',
            '**:data-flux-menu-item-icon:text-slate-600 [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ]
    })
    ;
